...
data class MemoryType(var index:Int = -1, var flags: VkMemoryPropertyFlags = 0) {
    ...
    val isDeviceLocal get()  = flags.isSet(VK10.VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT)
    val isHostVisible get()  = flags.isSet(VK10.VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
    val isHostCoherent get() = flags.isSet(VK10.VK_MEMORY_PROPERTY_HOST_COHERENT_BIT)
